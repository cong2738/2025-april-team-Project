...
set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[0]  }]; #IO_L5P_T0_34               ,Sch=SW8
set_property -dict { PACKAGE_PIN T3   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[1]  }]; #IO_L2N_T0_34               ,Sch=SW9
set_property -dict { PACKAGE_PIN T2   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[2] }]; #IO_L1N_T0_34               ,Sch=SW10
set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[3] }]; #IO_L2P_T0_34               ,Sch=SW11
# set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[4] }]; #IO_L5N_T0_34               ,Sch=SW12
# set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[5] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
# set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[6] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
# set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { GPIOD[7] }]; #IO_L1P_T0_34               ,Sch=SW15
...
set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[0]  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
set_property -dict { PACKAGE_PIN V3   IOSTANDARD LVCMOS33 } [get_ports { GPIOC[1]  }]; #IO_L6P_T0_34                 ,Sch=LED9
set_property -dict { PACKAGE_PIN W3   IOSTANDARD LVCMOS33 } [get_ports { GPIOC[2] }]; #IO_L6N_T0_VREF_34            ,Sch=LED10
set_property -dict { PACKAGE_PIN U3   IOSTANDARD LVCMOS33 } [get_ports { GPIOC[3] }]; #IO_L9P_T1_DQS_34             ,Sch=LED11
...
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { GPIOD[4] }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { GPIOD[5] }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { GPIOD[6] }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { GPIOD[7] }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND
...
set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports { DHT11_DATA }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10
# Vivado 자동 IOBUF 생성을 끄고
set_property IOBUF FALSE           [get_ports { DHT11_DATA }];
# DHT11에 필요한 풀업 저항 켜기
